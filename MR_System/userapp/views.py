...
def readExcel(request):
    ...
    df = pd.read_excel('D:/E-Drive/SEM-6/SDP/Implementation_VS_code/13_03_2021_updated_SDP_Project/MR_System/userapp/templates/AmazonSDPDataset_original.ods', engine='odf', usecols= ['reviewText','overall'])
    df['reviewText'] = df['reviewText'].apply(lambda x: get_clean(x))
